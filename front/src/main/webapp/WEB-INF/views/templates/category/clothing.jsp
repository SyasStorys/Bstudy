		...
		<div class="col-lg-12">
			...
			<c:if test="${userClickShowProduct == true}">
				...
				<nav aria-label="breadcrumb">
		         <ol class="breadcrumb">
		           <li class="breadcrumb-item"><a href="${contextRoot }/home">Home</a></li>
		           <li class="breadcrumb-item"><a href="${contextRoot }/show/all/products">${category.name }</a></li>
			...
			<div class="card sidebar-menu mb-4">
				...
				<div class="card-body">
					<ul class="nav nav-pills flex-column category-menu">
						...
						<li><a href="category.html" class="nav-link active">${category.name }
						...
						<div class="col-md-12 col-lg-7 products-number-sort">
							<form
								...
								<div class="products-number">
									<strong>Show</strong><a href="#" class="btn btn-sm btn-primary">12</a><a
										href="#" class="btn btn-outline-secondary btn-sm">24</a><a
										href="#" class="btn btn-outline-secondary btn-sm">All</a><span>products</span>
								</div>
